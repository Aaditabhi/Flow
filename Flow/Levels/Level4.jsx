...
const Level4 = () => {
  ...
  for (let row = 0; row < rows; row++) {
    ...
    for (let col = 0; col < cols; col++) {
        if((col == 0 && row == 3)|| (col == 1 && row == 0)){
        ...
        else if ((col == 0 && row == 4) || (col == 2 && row == 0)){
        ...
        else if ((col == 3 && row == 0) || (col == 3 && row == 4)){
        ...
        else if ((col == 3 && row == 1) || (col == 2 && row == 2)){
          ...
          else if ((col == 2 && row == 4) || (col == 3 && row == 3)){
