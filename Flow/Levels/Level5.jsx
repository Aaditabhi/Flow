...
const Level5 = () => {
  ...
  const [isComplete, setIsComplete] = useState([false,false,false,false])
  ...
  for (let row = 0; row < rows; row++) {
    ...
    for (let col = 0; col < cols; col++) {
        ...
        else if ((col == 0 && row == 1) || (col == 3 && row == 0)){
        ...
        else if ((col == 1 && row == 4) || (col == 3 && row == 3)){
        ...
        else if ((col == 2 && row == 4) || (col == 2 && row == 2)){
